    ...
    return <li id="regist-url">
      ...
      <div id="input-url">
        <div className="regist-item-set">
          <input type={this.props.type} id={this.props.name} name={this.props.name} onChange={this.doChange} value={this.state.urlValues[0].value} className={this.props.className} />
